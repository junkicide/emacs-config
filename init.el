...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-mode magit nov calfw-ical notmuch lispy yasnippet which-key vertico treemacs spaceline sly samskritam rustic rainbow-delimiters projectile ox-reveal org-roam-ui multiple-cursors marginalia direnv dashboard company-fuzzy color-theme-sanityinc-tomorrow calfw-org calfw)))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Pragmata Pro" :slant normal :weight normal :height 140 :width normal)))))
